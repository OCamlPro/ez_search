...
# -*- coding: utf-8 -*-
#
# ez_search documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_search.tex', 'ez_search Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_search', 'ez_search Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_search', 'ez_search Documentation',
     author, 'ez_search', 'One line description of project.',
     'Miscellaneous'),
]
